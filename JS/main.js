/**
 * Created by gggywww on 2015/11/13.
 */
var can1;
var can2;
var ctx1;
...
var my;
var  baby;
var  babyTail = [];var babyEye = [];var babyBoby = [];
var momTail = [];var momEye = [];
var data;
var momBodyOra = [];
var momBodyBlue = [];
var wave;
...
function init()
{
    ...
    can2 = document.getElementById("canvas2");//bg,one,fruits
    ...
    for(var i = 0;i < 20;i ++)
    {
        ...
        babyBoby[i].src = "./src/babyFade" + i + ".png";
    }
    for(var  i = 0;i < 8;i++)
    {
        momTail[i] = new  Image();
